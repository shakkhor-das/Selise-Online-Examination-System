    ...
    if(!isset($_SESSION['username'])){
        ...
        if(isset($_POST['update'])){
          ...
          if(empty($title)){
            ...
            $postid = $_GET["id"];
            $sql = "UPDATE opai_user_blog SET title='$title',post='$post' WHERE id = '$postid' ORDER BY id desc";
	...
	<!--<div class="wrapper">
      ...
      <div class="container">
        <div class="jumbotron">
          ...
          <form action="user_editpost.php?id=<?php echo $postidfromurl; ?>" method ="post">
