...
<<<<<<< HEAD:guesthome.php
      ...
      <div class="view" style="background-color: #dae1ed; background-repeat: no-repeat; background-size:cover; background-position: center center;height:700px;">
        ...
        <div class="container" id="cards" style="margin:70px;">
          
            <div class="row">
                    
              <div class="col-4-lg"ml-3 style="padding-left:70px;">
                    ...
                    <div class="col-4-lg" ml-3 style="padding-left:60px;">
                        ...
                        <div class="col-4-lg" ml-3 style="padding-left:40px">
                                <div class="card" style="width:20rem;padding:5px  ">
        ...
        <div class="col" id="mission" >
          ...
          <div class="row" >
            ...
            <div class="col-4-lg"ml-3 style="padding-left:110px;padding-top: 30px;">
                      ...
                      <div class="card-body">
                          <h5 class="card-title" style="text-align: center;"> EVALUATION </h5>
                          <p class="card-text">
                                  The Internal Revenue Service has expanded its “Fresh Start” car insurance companies not on comparison sites initiative to help struggling taxpayers who owe taxes. All too often, a taxpayer owes money to the IRS and they just accept the fate of drowniuide will show you how to change the battery in your car's remote key entry fob Repair  
                              </p>
          ...
          <div class="row" style="padding-top:50px;">
              ...
              <div class="col-md-9 mb-md-0 mb-5">
                  ...
                  <div class="text-center text-md-left" >
                      <a class="btn btn-primary" type="submit" name="submit "onclick="document.getElementById('contact-form').submit();">Send</a>
                  </div>
      ...
      -
        ...
        <div class="col" class="wrapper" style="border:1px solid black ;text-align: center;background-color:  #dae1ed;">
          ...
          <!-- Footer -->
          <footer class="page-footer font-small blue pt-4" style="color:cornsilk">
    
              <!-- Footer Links -->
              <div class="container-fluid text-center text-md-left" style="background-color:#2d343f">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mt-md-0 mt-3">
                    ...
                    <!-- Content -->
                    <h5 class="text-uppercase">ONLINE EXAMINATION SYSTEM</h5>
                  ...
                  <div class="col-md-3 mb-md-0 mb-3" >
                    ...
                    <!-- Links -->
                    <h5 class="text-uppercase">PRIMARY</h5>
              ...
              <div class="footer-copyright text-center py-3" style="background-color:black">
                <p>© 2019 Secure Link Services AG. All Rights Reserved.</p>
              </div>
              <!-- Copyright -->
