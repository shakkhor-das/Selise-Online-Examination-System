        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Test Password</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="" method="post" class="formm-inline" name="testpass">
                        <div class="form-group mx-sm-3 mb-2">
                            <label for="inputPassword2" class="sr-only">Password</label>
                            <input type="password" class="form-control" id="inputPassword2" placeholder="Password" name="testpassword" required>
                        </div>
                </div>
                <div class="modal-footer">
                    <input type="submit" class="btn btn-primary" value="Confirm" name="submit" id="passwordsubmit">
                    </form>
...
<script>
    $(document).ready(function(){
        $("#passwordsubmit").click(function(){
            var pass=document.forms['testpass']['testpassword'].value;
            var testpass="<?php echo $ans2["test_password"]?>";
            if(pass!=testpass){
...
<script>
    $(document).ready(function(){
        <?php
        $var=0;
        $sql3="SELECT * FROM `opai_user_registeredtable` WHERE userid='$id' AND testid='$testid'";
        $q3=mysqli_query($con,$sql3);
    ...
    $(document).ready(function(){
        $("#mybtn1").click(function(){
            var vis="<?php echo $ans2["test_visibility"];?>";
            if(vis=="public"){
                $("#mybtn1").hide();
                $("#mybtn2").show();
                var testid="<?php echo $ans2["test_id"];?>";
