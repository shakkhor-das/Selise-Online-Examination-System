  ...
  <body>
              ...
              <ul class="navbar-nav ml-auto flex-nowrap">
					...
					<li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown_target">
                            <a class="dropdown-item" href="testOptions.php">Take A Test</a>
                            <a class="dropdown-item" href="userPrevious.php">My Previous Tests</a>
	...
	<div class="wrapper">
            ...
            <div class="card" style="">
                ...
                <div class="card-body">
					<form action="setterprofilesubmit.php" method="post" name="userProfile">
